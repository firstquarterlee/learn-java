...
public class _05_VariableNaming {
    public static void main(String[] args) {
        ...
        String firstName = "순신"; // 이름
        String lastName = "이"; // 성
        String dateOfBirth = "1545-04-28"; // 생년월일
        String residentialAddress = "거북선 호텔"; // 체류지
        String purposeOfVisit = "관광"; // 입국목적
        String flightNo = "KE657"; // 항공 편명
        String _flightNo = "KE657"; // 밑줄 시작
        String flight_no_2 = "KE657"; // 밑줄과 숫자 포함
        // String -flightNo = "KE657"; // 안됨!
